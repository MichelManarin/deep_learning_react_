    ...
    <div className='h-full bg-gray-50 flex min-h-full flex-1 flex-col justify-center py-12 sm:px-6 lg:px-8'>
      <div className='mt-10 sm:mx-auto sm:w-full sm:max-w-[800px]'>
        <div className='bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12'>
          ...
          <div>
            <button className="rounded bg-white px-2 py-3 text-xs font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 py-" onClick={async (): Promise<void> => await processFrames()}>Analyse frame</button>
